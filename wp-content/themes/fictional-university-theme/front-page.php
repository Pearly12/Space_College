...
<div class="page-banner">
      ...
      <div class="page-banner__content container t-center c-white">
        <h1 class="headline headline--large">Welcome to Space College!</h1>
        <h2 class="headline headline--medium">Shoot for the stars!</h2>
    ...
    <div class="hero-slider">
      ...
      <div data-glide-el="track" class="glide__track">
        ...
        <?php 
          $homepageSliderPosts = new WP_Query(array(
            'posts_per_page' => 3,
            'post_type' => 'homepageSlideshow'
          ));

          while($homepageSliderPosts->have_posts()){
